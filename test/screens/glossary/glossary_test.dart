...
main() {
  testWidgets(
    ...
    //assemble
    final glossarys = [
      Glossary(aircraftid:-1, id: -1, title: 'title 1', body: 'body 1'),
      Glossary(aircraftid:-1, id: -1, title: 'title 2', body: 'body 2'),
      Glossary(aircraftid:-1, id: -1, title: 'title 3', body: 'body 3')
    ];
