...
main() {
  testWidgets(
    ...
    //assemble
    final glossarys = [
      Glossary(aircraftId:-1, glossaryId: -1, name: 'title 1', body: 'body 1'),
      Glossary(aircraftId:-1, glossaryId: -1, name: 'title 2', body: 'body 2'),
      Glossary(aircraftId:-1, glossaryId: -1, name: 'title 3', body: 'body 3')
    ];
